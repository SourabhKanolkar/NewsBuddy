...
const App = () => {
  const pageSize = 5;
  const apiKey = '04841c3fa9e74988b2203b4b976a127d';
    ...
    <>
      ...
      <Routes>
        ...
        <Route
          exact
          path="/general"
          element={<News setProgress={setProgress} apiKey={apiKey} key="general2" pageSize={pageSize} country="in" category="general" />}
        />
        <Route
          exact
          path="/health"
